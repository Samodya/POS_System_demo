            ...
            <div className="flex-1 p-6 w-full">
                <div className="bg-white shadow-xl rounded-2xl p-6">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
                        <h2 className="text-xl font-bold text-gray-800 mb-2 md:mb-0">New Repair</h2>
                        <div className="flex items-center space-x-2">
                            <span className="text-sm font-semibold text-gray-600">Order ID:</span>
                            <span className="font-mono text-blue-700 font-medium">{orderId}</span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-md font-semibold text-gray-700">Customer Details</h3>
                                                ...
                                                .map((c) => (
                                                    <div
                                                        ...
                                                        className={`px-3 py-2 cursor-pointer text-sm flex items-center gap-2 ${
                                                            customerid === c.id ? "bg-blue-50 text-blue-800" : "hover:bg-gray-100"
                                                        }`}
                                                    >
                                                        <UserIcon />
                                                        {c.name} - <span className="text-gray-500">{c.phone}</span>
                                                    </div>
                                                ))}
                                        </div>
                                    )}
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <div className="space-y-1">
                                            ...
                                            <input
                                                ...
                                                style={{ backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" /></svg>')`, backgroundRepeat: 'no-repeat', backgroundPosition: 'left 0.5rem center', backgroundSize: '1.25rem' }}
                                            />
                                        </div>
                                        <div className="space-y-1">
                                            ...
                                            <input
                                                ...
                                                className={inputClasses}
                                                style={{ backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.774a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/></svg>')`, backgroundRepeat: 'no-repeat', backgroundPosition: 'left 0.5rem center', backgroundSize: '1.25rem' }}
                                            />
                                        </div>
                                    </div>
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            className={inputClasses}
                                            style={{ backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" /><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" /></svg>')`, backgroundRepeat: 'no-repeat', backgroundPosition: 'left 0.5rem center', backgroundSize: '1.25rem' }}
                                        />
                                    </div>
                                    <div className="space-y-1">
                        ...
                        {/* Repair Details */}
                        <div className="space-y-4">
                            <h3 className="text-md font-semibold text-gray-700">Repair Details</h3>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    ...
                                    <input
                                        ...
                                        className={inputClasses}
                                        style={{ backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path d="M15 8a3 3 0 10-2.977-2.977l-1.255 1.255a4 4 0 11-1.414 1.414l-1.255-1.255a3 3 0 10-2.977 2.977H12a2 2 0 110 4h-1.586a1 1 0 01-.707-.293l-1.586-1.586a1 1 0 00-1.414 0L5.293 12.293a1 1 0 00-.707.707L4 14.586V16a2 2 0 11-2-2h2a2 2 0 114 0h.586l.293-.293A1 1 0 008 13.586l1.586 1.586a1 1 0 00.707.293H12a4 4 0 10-.001-6.928l-1.255 1.255z"/></svg>')`, backgroundRepeat: 'no-repeat', backgroundPosition: 'left 0.5rem center', backgroundSize: '1.25rem' }}
                                    />
                                </div>
                                <div className="space-y-1">
                                    ...
                                    <select
                                        ...
                                        className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-300"
                                    >
                                ...
                                <div className="space-y-1">
                                    <label className="block text-xs font-medium text-gray-600">Received Date</label>
                                    <input
                                        type="date"
                                        value={receivedDate}
                                        onChange={(e) => setReceivedDate(e.target.value)}
                                        className={inputClasses}
                                        style={{ backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd" /></svg>')`, backgroundRepeat: 'no-repeat', backgroundPosition: 'left 0.5rem center', backgroundSize: '1.25rem' }}
                                    />
                                </div>
                                <div className="space-y-1">
                                    <label className="block text-xs font-medium text-gray-600">Completed Date</label>
                                    <input
                                        type="date"
                                        value={completedDate}
                                            ...
                                            .map((u) => (
                                                <div
                                                    ...
                                                    className={`px-3 py-2 cursor-pointer text-xs flex items-center gap-2 ${
                                                        assignedUserId === u.id ? "bg-blue-50 text-blue-800" : "hover:bg-gray-100"
                                                    }`}
                                                >
                                                    <UserIcon />
                                                    {u.fullname}
